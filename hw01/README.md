...
```
vagrant cloud publish --release ychahovets/centos-7-5 1.0 virtualbox \
...
Здесь:
 ...
 - `ychahovets/centos-7-5` - `ychahovets`, указаный при публикации и имя образа;
 - `1.0` - версия образа;
 - `virtualbox` - провайдер;
 - `centos-7.7.1908-kernel-5-x86_64-Minimal.box` - имя файла загружаемого образа;

После успешной загрузки получено сообщение:

```
$ vagrant cloud publish --release ychahovets/centos-7-5 1.0 virtualbox centos-7-5.box
You are about to publish a box on Vagrant Cloud with the following options:
ychahovets/centos-7-5:   (v1.0) for provider 'virtualbox'
Automatic Release:     true
Do you wish to continue? [y/N]y
Saving box information...
Uploading provider with file /home/ych/other/manual_kernel_update/test/centos-7-5.box
Releasing box...
Complete! Published ychahovets/centos-7-5
Box:              ychahovets/centos-7-5
Description:
Private:          no
Created:          2021-09-02T12:41:00.437+03:00
Updated:          2021-09-02T12:45:47.033+03:00
Current Version:  N/A
Versions:         1.0
Downloads:        0
```
